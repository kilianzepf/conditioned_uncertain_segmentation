...
from models.c_prob_unet import Style_ProbabilisticUnet
from utils.utils import *
from utils.metrics import *
from models.c_prob_unet import *
from dataloaders import *
import evaluate_style_prob_unet
...
parser.add_argument(
    ...
    default=6,
    type=int,
    help="Dimension of the latent space. Default is 6",
)
parser.add_argument(
    "--W",
    default=1,
...
def train(
    ...
    for epoch in tqdm(range(resume_epoch, epochs)):  # may be error in range
        ...
        for images, masks, _, style_label in train_loader:
            ...
            model.forward(images, masks, style_label, training=True)
            # Calculate the Elbo
        ...
        with torch.no_grad():
            for images, masks, seg_dist, style_label in val_loader:
                ...
                model.forward(
                    images, masks, style_label, training=False
                )  # outputs logits
...
if __name__ == "__main__":
    ...
    config = dict(
        ...
        latent_dimension=latentdim,
        loss="(Elbo) Reconstruction Loss: BCEWithLogitsLoss / KL",
        architecture="Style Probabilistic U-Net",
    ...
    if W:
        ...
        wandb.init(
            ...
            group="Style Probabilistic Unets",
            job_type="Training",
            config=config,
            dir="/scratch/kmze",
        )
    ...
    prob_unet = Style_ProbabilisticUnet(
    ...
    print(f"Saved: {training_run_name} Data: {what_task} Model: Style Prob. U-Net")
    # End Training Run
    if W:
        wandb.finish
    ...
    if args.testit == True:
        ...
        evaluate_style_prob_unet.evaluate(
            model=prob_unet,
